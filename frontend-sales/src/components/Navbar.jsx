        ...
        <div className="flex gap-6 items-center">
          ...
          {currentUser ? (
            ...
            <div className="flex gap-3">
              ...
              <Link to="/login" className="bg-cyan-600/20 text-cyan-400 border border-cyan-500/50 hover:bg-cyan-600 hover:text-white px-5 py-2 rounded-lg text-sm font-bold uppercase tracking-wider transition-all shadow-[0_0_15px_rgba(34,211,238,0.1)] hover:shadow-[0_0_20px_rgba(34,211,238,0.3)]">
                Daftar
              </Link>
            </div>
          )}
