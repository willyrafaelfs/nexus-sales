    ...
    try {
      const response = await fetch('http://localhost:8888/api/products', {
        ...
        headers: {
          ...
          // Tidak perlu set Content-Type karena FormData mengaturnya secara otomatis (multipart/form-data)
        },
        body: formData
      });
      ...
      <div className="bg-gray-900 p-8 rounded-xl border border-gray-800 shadow-2xl">
        ...
        <form ref={formRef} onSubmit={handleSubmit} className="space-y-5">
          ...
          <button 
            type="submit" 
            disabled={isLoading} 
            className={`w-full mt-8 font-bold py-3.5 rounded-lg uppercase tracking-wider transition-all shadow-[0_0_15px_rgba(34,211,238,0.2)] ${
              isLoading 
